...
RSpec.describe Esse::CLI::Index, type: :cli do
  describe '#update_setting' do
    it 'raises an error if no index name is given' do
      expect {
        cli_exec(%w[index update_setting])
    ...
    it 'raises an error if given argument is not a valid index class' do
      expect {
        cli_exec(%w[index update_setting Esse::Config])
    ...
    it 'raises an error if given argument is not defined' do
      expect {
        cli_exec(%w[index update_setting NotDefinedIndexName])
    ...
    context 'with a valid index name' do
      ...
      specify do
        ...
        cli_exec(%w[index update_setting CountiesIndex])
      end
      ...
      specify do
        ...
        cli_exec(%w[index update_setting CountiesIndex --suffix=foo])
      end
      ...
      it 'allows multiple indices' do
        ...
        cli_exec(%w[index update_setting CountiesIndex CitiesIndex])
      end
    end
  end
end
