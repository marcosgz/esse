...
RSpec.shared_examples 'transport#update_mapping' do
  it 'raises an Esse::Transport::ReadonlyClusterError exception when the cluster is readonly' do
    es_client do |client, _conf, cluster|
      ...
      expect {
        cluster.api.update_mapping(index: "#{cluster.index_prefix}_readonly", body: {})
  ...
  it 'raises an Esse::Transport::ServerError exception when api throws an error' do
    es_client do |client, _conf, cluster|
      expect {
        cluster.api.update_mapping(index: 'esse_unknow_index_name_v1', body: {})
  ...
  it 'updates the mapping' do
    es_client do |client, _conf, cluster|
      ...
      expect {
        cluster.api.update_mapping(index: index_name, body: {
          properties: {
            name: { type: 'text' },
          },
        })
      ...
      expect(mapping.dig(index_name, 'mappings', 'properties')).to eq(
        'name' => { 'type' => 'text' },
      )
    end
  end
